...
$_['entry_relatedbysales_status'] = 'Add products based on items sold together. <div style="color: red;">Attention! In the template settings on the main tab, configure and activate CRON for "Frequently Bought Together"</div>';
...
$_['tab_official_rep']         = 'Manufacturer block';
...
$_['entry_mobile_menu_skype']		   = 'Display "Teams"';
...
$_['entry_theme']                   = 'Default theme';
$_['entry_theme_light']              = 'Light theme';
$_['entry_theme_dark']               = 'Dark theme';
...
$_['entry_use_minimum_step'] = 'Increase the quantity of the product in multiples of the minimum quantity? Works on the product page, in the popup cart, in the popup product view, and on the checkout page.';
...
$_['text_light_theme'] = 'Light Theme';
$_['text_dark_theme'] = 'Dark Theme';
$_['entry_main_color'] = 'Main Color of Elements';
$_['entry_link_color'] = 'Link Color';
$_['entry_link_hover_color'] = 'Link Hover Color';
$_['entry_special_price_color'] = 'Special Price Color';
$_['entry_interactive_button_color'] = 'Interactive Button Color';
$_['entry_primary_text_color'] = 'Primary Text Color';
$_['logo_dark_placeholder'] = 'Logo for use in dark theme';
$_['entry_secondary_text_color'] = 'Secondary Text Color';
$_['entry_header_background_color'] = 'Header Background Color';
$_['entry_footer_background_color'] = 'Footer Background Color';
$_['entry_footer_text_color'] = 'Footer Text Color';
$_['entry_footer_title_color'] = 'Footer Title Color';
$_['text_product_limits']			   = 'Limits';
$_['text_main_colors']			   	   = 'Main colors';
$_['entry_main_text_color_light']	   = 'Light theme text color';
$_['entry_main_text_color_dark']	   = 'Dark theme text color';
...
$_['text_main_color_settings']		   = 'Appearance';
$_['text_online_store']                  = 'Online Store (Universal)';
$_['text_store']                         = 'Store (General)';
$_['text_local_business']                = 'Local Business';
$_['text_auto_dealer']                   = 'Auto Dealer';
$_['text_auto_parts_store']              = 'Auto Parts Store';
$_['text_book_store']                    = 'Book Store';
$_['text_clothing_store']                = 'Clothing Store';
$_['text_computer_store']                = 'Computer Store';
$_['text_department_store']              = 'Department Store';
$_['text_electronics_store']             = 'Electronics Store';
$_['text_florist_shop']                  = 'Florist Shop';
$_['text_furniture_store']               = 'Furniture Store';
$_['text_garden_store']                  = 'Garden Center';
$_['text_grocery_store']                 = 'Grocery Store';
$_['text_hardware_store']                = 'Hardware Store';
$_['text_hobby_shop']                    = 'Hobby Shop';
$_['text_home_goods_store']              = 'Home Goods Store';
$_['text_jewelry_store']                 = 'Jewelry Store';
$_['text_liquor_store']                  = 'Liquor Store';
$_['text_mens_clothing_store']           = 'Men\'s Clothing Store';
$_['text_mobile_phone_store']            = 'Mobile Phone Store';
$_['text_movie_rental_store']            = 'Movie Rental Store';
$_['text_music_store']                   = 'Music Store';
$_['text_office_equipment_store']        = 'Office Equipment Store';
$_['text_outlet_store']                  = 'Outlet Store';
$_['text_pet_store']                     = 'Pet Store';
$_['text_shoe_store']                    = 'Shoe Store';
$_['text_sporting_goods_store']          = 'Sporting Goods Store';
$_['text_tire_shop']                     = 'Tire Shop';
$_['text_toy_store']                     = 'Toy Store';
$_['text_wholesale_store']               = 'Wholesale Store';
...
$_['entry_contact_teams']			   = 'Microsoft Teams';
...
$_['entry_rep_title']          = 'Block title';
$_['entry_rep_all']            = 'All manufacturers';
$_['entry_rep_manuf']          = 'Only for manufacturers';
$_['entry_rep_descr']          = 'Description support HTML';
$_['button_add_rep']           = 'Add manufacturer description block';
$_['entry_rep_logo']           = 'Manufacturer logo';
...
$_['entry_show_feedback_teams']	   	   = 'Enable Teams';
...
$_['entry_category_page_number']	   = 'Add page number to meta title and description if the SEO generator from OCTemplates is enabled?';
...
$_['entry_city']          = 'City';
$_['entry_org_type']			   	   = 'Organization type';
$_['help_org_type']			   	   = 'Select the type of organization that best matches your business. This will help search engines better understand your site.';
$_['entry_address']       = 'Address';
$_['entry_country'] = 'Country ISO code';
$_['entry_postal_code']   = 'Postal code';
$_['entry_phones']        = 'Phone(s)';
$_['entry_email']         = 'Email';
$_['entry_social_links']  = 'Social networks';
$_['entry_legal_name']    = 'Full legal name';
$_['entry_founding_date'] = 'Founding date';
$_['entry_area_served']   = 'Service area (ISO country codes)';
$_['entry_shipping_cost'] = 'Shipping cost';
$_['entry_price_range'] = 'Price range';
$_['entry_currencies_accepted'] = 'Accepted currencies';
$_['entry_payment_accepted'] = 'Payment methods';
$_['entry_processing_time'] = 'Maximum order processing time (days)';
$_['entry_delivery_time'] = 'Maximum order delivery time (days)';
$_['entry_return_time'] = 'Product return period (days)';
...
$_['entry_sub_links']        = 'Nested links';
$_['entry_sub_link_title']   = 'Link title';
$_['entry_sub_link_href']    = 'Link URL';
$_['entry_sub_link_sort']    = 'Sort order';
$_['button_add_sub_link']    = 'Add nested link';
$_['text_sub_link']          = 'Nested link';
...
$_['help_rep_all']                     = 'Assign this block to all manufacturers?';
$_['help_rep_logo']                    = 'Display the manufacturer\'s logo?';
$_['help_rep_manuf']                   = 'Display only for selected manufacturers';
$_['help_microdata'] = 'Structured data for search engines (schema.org). Helps Google better understand your website content and improves display in search results.';
$_['help_country'] = 'Two-letter country code according to ISO 3166-1 standard. Examples: UA (Ukraine), US (USA), DE (Germany), PL (Poland)';
$_['help_city'] = 'Name of the city where your company or main office is located. Example: Kyiv';
$_['help_postal_code'] = 'Postal code of your city or main office. Examples: 65088 (Odesa), 01001 (Kyiv), 61000 (Kharkiv)';
$_['help_legal_name'] = 'Full official name of your company according to registration documents. Examples: LLC "Online Store", Individual Entrepreneur Ivanenko Ivan';
$_['help_founding_date'] = 'Date of official registration or start of your company activity. Format: DD.MM.YYYY (for example: 15.03.2020)';
$_['help_service_area'] = 'ISO country codes where you deliver goods or provide services. Examples: UA (only Ukraine), UA,PL,MD (multiple countries)';
$_['help_delivery_cost'] = 'Delivery cost. Examples: 75. Enter only the number without currency symbol. 0 - do not display delivery cost in product microdata.';
$_['help_processing_time'] = 'Maximum order processing time before shipping in days. Examples: 1 (items in stock), 3 (items on order)';
$_['help_delivery_time'] = 'Maximum delivery time after shipping in days. Examples: 2 (within Ukraine), 10 (international delivery)';
$_['help_return_period'] = 'Period in days during which the buyer can return the product. According to Ukrainian law minimum 14 days. Examples: 14, 30, 90';
$_['help_latitude'] = 'Latitude of your company\'s location. Used for precise placement on the map. Examples: 46.4825 (Odesa), 50.4501 (Kyiv)';
$_['help_longitude'] = 'Longitude of your company\'s location. Used for precise placement on the map. Examples: 30.7233 (Odesa), 30.5234 (Kyiv)';
$_['help_price_range'] = 'Price ranges for display in Google search results. Formats: ₴/₴₴/₴₴₴/₴₴₴₴ (categories from budget to luxury), ₴100-₴5000 (exact range), $10-$500 (currency range), "Budget products" (text description). Improves local SEO and rich snippets. Enter 0 or leave blank to hide.';
$_['help_address'] = 'Full address of your company, including street, building number, office, etc. Examples: 2 Heroiv Krut St., office 101; 50 Pobedy Ave.';
$_['help_currencies_accepted'] = 'ISO currency codes you accept. Examples: UAH (Ukrainian Hryvnia), USD (US Dollar), EUR (Euro). Separate with commas, e.g.: UAH,USD,EUR';
$_['help_payment_accepted'] = 'Payment methods you accept. Examples: "Cash", "Credit Card", "PayPal", "Bank Transfer". Separate with commas, e.g.: Cash,Credit Card,PayPal';
