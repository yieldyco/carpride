<?php
include(DIR_LANGUAGE . 'uk-ua/seolang/langmark.php');
include('seolang.php');
...
$_['tab_other']  = 'Прочие';
$_['entry_two_status'] = 'Исправление "повторяющихся слешей //" в URL<br><span class="lm-help">Работает только с SeoPro</span>';
...
$_['entry_id'] = 'ID';
$_['entry_seo_pagination'] = 'SEO URL сроки пагинации<br><span class="helpshow">вроде .../page-2</span><br><span class="helpshow">(Не рекомендуется)</span>';

$_['entry_multi_sort'] = 'Порядок сортировки';

$_['entry_redirect_new'] = 'Редирект (старых URL без префикса) <br>на новые URL с префиксом языка<br><span class="lm-help">Включать <b>только в случае</b> <br>если у вас старые URL уже <br>проиндексированы поисковыми системами. <br>На новом магазине - не включать</span>';
$_['entry_redirect_code'] = 'Код редиректа <br><span class="lm-help">301 (постоянный) или <br>302 (временный)</span>';

$_['entry_ex_url_amp'] = 'Замена в URL амперсанда <br>& на &amp;amp;';

$_['entry_main_prefix_url'] = 'Изменение префикса главной страницы<br><span class="vhelp">Работает, когда включена опция "Убрать языковой префикс главной страницы"<br></span>';

$_['entry_hreflang_canonical'] = 'Использовать для hreflang <br>canonical (каноническую) страницу';
