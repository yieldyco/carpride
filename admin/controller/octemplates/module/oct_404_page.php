...
class ControllerOCTemplatesModuleOct404Page extends Controller {
    ...
    public function addEvent() {
		...
		if ($this->model_setting_event->getEventByCode('octemplates-deals-404-not-found')) {
			return;
		}
		...
		$events = [
			[
				'code' => 'octemplates-deals-404-not-found',
	...
	public function deleteEvent() {
		...
		$eventCodes = [
			'octemplates-deals-404-not-found'
		];
