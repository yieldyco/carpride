...
class ControllerExtensionModuleOctSlideshowPlus extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['slider_type'])) {
			...
			$data['slider_type'] = isset($module_info['slider_type']) ? $module_info['slider_type'] : 1;
		} else {
			$data['slider_type'] = 1;
		}
		...
		if (isset($this->request->post['slider_autoplay'])) {
			...
			$data['slider_autoplay'] = isset($module_info['slider_autoplay']) ? $module_info['slider_autoplay'] : 0;
		} else {
		...
		if (isset($this->request->post['arrows_status'])) {
			...
			$data['arrows_status'] = isset($module_info['arrows_status']) ? $module_info['arrows_status'] : '';
		} else {
			$data['arrows_status'] = '';
		}
