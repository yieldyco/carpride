...
//		$pagination->text = $this->language->get('text_pagination');
  	...
  	private function getForm() {
		...
		$data['text_ddesc3'] = $this->language->get('text_ddesc3');
		...
		$data['text_ad17'] = $this->language->get('text_ad17');
		...
		$data['text_command282'] = $this->language->get('text_command282');
		$data['text_command283'] = $this->language->get('text_command283');
		$data['text_command284'] = $this->language->get('text_command284');
		$data['text_command285'] = $this->language->get('text_command285');
		$data['text_command286'] = $this->language->get('text_command286');
		$data['text_command287'] = $this->language->get('text_command287');
		$data['text_command288'] = $this->language->get('text_command288');
		$data['text_command289'] = $this->language->get('text_command289');
		$data['text_command290'] = $this->language->get('text_command290');
		$data['text_command291'] = $this->language->get('text_command291');
		$data['text_command292'] = $this->language->get('text_command292');
		$data['text_command293'] = $this->language->get('text_command293');
		$data['text_command294'] = $this->language->get('text_command294');
		...
		$data['entry_point2'] = $this->language->get('entry_point2');
		$data['entry_point3'] = $this->language->get('entry_point3');
		...
		$data['entry_first0'] = $this->language->get('entry_first0');
		$data['entry_first1'] = $this->language->get('entry_first1');
		$data['entry_first2'] = $this->language->get('entry_first2');
		$data['entry_first3'] = $this->language->get('entry_first3');
		...
		$data['entry_f_json'] = $this->language->get('entry_f_json');
		$data['entry_f_json'] = $this->language->get('entry_f_json');
		...
		if (isset($this->request->post['fdate'])) {
			...
			$data['fdate'] = $suppler_info['fdate'];
		} else {
      		$data['supplers']['fdate'] = 0;
    	}
		
		if (isset($this->request->post['ldate'])) {
      		$data['ldate'] = $this->request->post['ldate'];
    	} elseif (!empty($suppler_info)) {
			$data['ldate'] = $suppler_info['ldate'];
		} else {
      		$data['supplers']['ldate'] = '2000-01-01';
    	}
