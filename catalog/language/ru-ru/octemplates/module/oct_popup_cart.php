...
$_['text_items']               = '<span class="d-none">%s товаров</span>Всего: <span class="ds-cart-popup-total">%s</span>';
...
$_['free_shipping_from']       = 'До бесплатной доставки осталось: <b>%s</b>';
$_['free_shipping_get']        = 'Поздравляем! У вас бесплатная доставка';
...
$_['error_minimum_order']      = 'Внимание! Минимальная сумма заказа <b>%s</b>';