...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
        ...
        /*attribute_text_select*/$this->load->model('catalog/attribute_text_select');/*end attribute_text_select*/
    ...
    // SEO Tags Generator . end
        ...
        $this->model_catalog_attribute_text_select->insertAttribTextProduct($product_id, $data);
        //if($this->model_catalog_attribute_text_select->isStatusModule()) {$data['product_attribute'] = array();}
    ...
    // SEO Tags Generator . end
		...
		/*attribute_text_select*/if(!isset($data['attribute_text_empty'])) {/*end attribute_text_select*/
            
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_attribute WHERE product_id = '" . (int)$product_id . "'");

		/*attribute_text_select*/}/*end attribute_text_select*/
	...
	public function copyProduct($product_id) {
		...
		if ($query->num_rows) {
            ...
            /*attribute_text_select*/
            $this->load->model('catalog/attribute_text_select'); $data['attribute_text'] = $this->model_catalog_attribute_text_select->getAttribTextProductById($product_id);
            /*end attribute_text_select*/
	...
	$query = $this->db->query("SELECT p.image FROM " . DB_PREFIX . "product p WHERE p.product_id = '" . (int)$product_id . "'");
        ...
        /*attribute_text_select*/
        $this->load->model('catalog/attribute_text_select'); $this->model_catalog_attribute_text_select->delProduct($product_id);
        /*end attribute_text_select*/
            
//		$this->db->query("INSERT INTO custom_product_last_category (product_id, category_id, category_url, date_saved) values ('".(int)$product_id."', '1', 'test', '".date('Y-m-d H:i:s')."')");
		...
		$sql = "SELECT * FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id)";
            ...
            # Admin Product Editor and extended Filter
                if (!empty($data['filter_product_id'])) {
                    $sql .= " AND p.product_id LIKE '%" . (int)$data['filter_product_id'] . "%'";
                }
	...
	public function getProductAttributes($product_id) {
        ...
        /*attribute_text_select*/
        //$this->load->model('catalog/attribute_text_select'); if($this->model_catalog_attribute_text_select->isStatusModule()) {$sort_text = false; return $this->model_catalog_attribute_text_select->getProductAttributes($product_id, $sort_text);}
        /*end attribute_text_select*/
...
'optsku'          		  => $product_option_value['optsku'],
	...
	public function getTotalProductsByAttributeId($attribute_id) {
        ...
        /*attribute_text_select*/
        $this->load->model('catalog/attribute_text_select'); if($this->model_catalog_attribute_text_select->isStatusModule()) {return $this->model_catalog_attribute_text_select->getTotalAttribTextProduct($attribute_id);}
        /*end attribute_text_select*/
