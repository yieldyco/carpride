...
class ModelCatalogAttribute extends Model {
	...
	public function deleteAttribute($attribute_id) {
		...
		/*attribute_text_select*/ $this->load->model('catalog/attribute_text_select'); $this->model_catalog_attribute_text_select->delAttribText($attribute_id); /*end attribute_text_select*/
