...
//CategoryManager end
            ...
            if($this->user->hasPermission('access', 'extension/module/attribute_text_select') && (($stat_mod = $this->config->get('module_attribute_text_select_status')) || ($stat_mod === '0'))) {
                $attribute[] = array(
					'name'     => 'Attribute Text Select',
					'href'     => $this->url->link('extension/module/attribute_text_select', 'user_token='.$this->session->data['user_token'], true),
					'children' => array()	
				);
            }
