...
//quicksave end
    ...
    // SEO Tags Generator . begin
		// A!
		// OpenCart pure is different from ocStore & OpenCartPRO!
		...
		if ($data['stg_status']) {
            ...
            'h1'						   => '',
					...
					if (array_key_exists('name_synonym', $manufacturer_info)) {
						$stg_manufacturer_info0['name_synonym'] = $manufacturer_info['name_synonym']; // for manufacturer_synonym
					}
					...
					if (isset($stg_manufacturer_info1['h1'])) {
						$data['stg_preview'][$language['language_id']]['h1'] = $stg_manufacturer_info1['h1']; // seo-tag-h1.ocmod.zip
					}
				}
			}
		}
