...
$_['heading_title']              = 'Orders';
        ...
        $_['text_trans_link']          				    = 'Withdraw request for payment (Invoice)';
        $_['text_info_invoice_order']          			= 'Invoice generation for order: No.';
        $_['text_invoice_base']          			    = 'Invoice: ';
        $_['text_invoice_copy']          			    = 'Copy invoice link';
        $_['text_invoice_delete']          			    = 'Invoice delete';
        $_['text_info_trans']          			        = 'Order information: ';
        $_['text_info_invoice_add']          			= 'Create invoice';
